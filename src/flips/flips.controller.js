...
// list route handler function for GET endpoint
...
// middleware function that checks for body property
...
// middleware function enhances create-flip validation by 
// checking result property value for H, T, or edge
...
// middleware function checks for flip ID
...
// route handler for flip/:flipId path
...
module.exports = {
  create: [bodyHasResultProperty, resultPropertyIsValid, create], // array that uses middleware functions before exporting
  list,
